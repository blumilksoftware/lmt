...
<section>
  ...
  <div class="mx-9 mb-32 mt-[90px] grid max-w-screen-2xl grid-cols-1 gap-7 text-white md:mt-44 lg:mx-3 lg:grid-cols-3 xl:px-14 2xl:mx-auto 2xl:px-0">
    <x-question>
      <x-slot:question>O co chodzi?</x-slot:question>
      <x-slot:answer>
        Organizujemy cykliczne spotkania w Legnicy, na których zaproszeni
        goście prezentują w różnej formie swoje doświadczenia i
        przemyślenia w dziedzinie inżynierii oprogramowania i sztucznej inteligencji.
      </x-slot:answer>
    </x-question>
    <x-question>
      ...
      <x-slot:answer>
        ...
        Zapraszamy programistów, grafików, administratorów, devopsów, nauczycieli
        oraz studentów, pasjonatów i hobbystów.
      </x-slot:answer>
    </x-question>
    <x-question>
      ...
      <x-slot:answer>
        ...
        zastosowania sztucznej inteligencji, metody cyfryzacji,
